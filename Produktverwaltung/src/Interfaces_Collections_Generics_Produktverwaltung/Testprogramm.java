...
public class Testprogramm {
	...
	public static void main(String[] args) {
		...
		Product buchKomTech = new Product("Kommunikationssysteme im Automobil", "Ein Buch f�r Komtech, IMA", 39.99, "Buch");
		...
		Product buchHackingUndSec = new Product("Hacking & Security", "Buch f�r Komtech", 99.99, "Buch");
